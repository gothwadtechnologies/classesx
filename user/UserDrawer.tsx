...
const UserDrawer: React.FC<UserDrawerProps> = ({ 
  ...
  return (
    <>
      ...
      <div 
        className={`absolute top-0 bottom-0 left-0 w-[75%] max-w-[280px] bg-white z-[110] transform shadow-2xl border-r border-slate-100 flex flex-col ${
        ...
        <div className="p-4 border-t border-slate-100 bg-slate-50 shrink-0">
          {!showLogoutConfirm ? (
            <button 
              ...
              className="w-full flex items-center justify-between px-4 py-4 text-rose-600 bg-white border border-rose-100 rounded-xl transition-all active:scale-95 shadow-sm"
            >
